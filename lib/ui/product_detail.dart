...
import 'package:kyle_test_app/ui/my_bag.dart';
...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Padding _Add2BagButton() {
    return Padding(
              padding: const EdgeInsets.all(16),
              child: ElevatedButton(child: Center(child: Text(strAddToBag)), onPressed: (){
                Navigator.push(
      context,
              ...
              ...sizeList
                  .map(
                    (e) {
                       ...
                       final widget = Text(e, style:TextStyle(color:  _selectedSizeIndex == index ? Colors.white : Colors.black) );
      ...
      child: Container(
        ...
        child: Card(        
          ...
          shape: RoundedRectangleBorder(
            ...
            color:  _selectedSizeIndex == index ? Colors.grey.shade600 : Colors.transparent,
